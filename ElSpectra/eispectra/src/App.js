...
import './App.css';
import Cats_gallery from './Components/Cats_gallary';
import MainLeftNavbar from './Components/MainLeftNavbar';
import Center_Navbar from './Components/Center_Navbar';
  ...
  const [dataBase, setDataBase] = useState([
    {
      ...
      name: "Luna",
      numberOfClicks: 0,
      image: "./Components/Cats_IMG/cat1.jpeg"
    },
    {
      id: 2,
      name: "puppy-rush",
      numberOfClicks: 0,
      image: "./Components/Cats_IMG/cat3.jpg"
    },
    {
      id: 3,
      name: "Simba",
      numberOfClicks: 0,
      image: "./Components/Cats_IMG/cat2.jpg"
    },
    {
      id: 4,
      name: "Tigger",
      numberOfClicks: 0,
      image: "./Components/Cats_IMG/cat5.jpeg"
    }
  ])
  ...
  return (
    <div className="App">
      ...
      <div className="top_div">
        <MainLeftNavbar dataBase={dataBase} displayLeftNavImage ={displayLeftNavImage}/>
        <Center_Navbar dataBase={initialMiddleImage} displayLeftNavImage={displayLeftNavImage} leftNavClick={leftNavClick} />
        <Rnavbar
      ...
      <Cats_gallery dataBase={dataBase} displayLeftNavImage ={displayLeftNavImage}/>
    </div>
  );
}
